...
/**
 * The simpledownloadFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_simpledownloadFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('Simpledownload_Form_Plugin_FormFrame', $params, $content);
