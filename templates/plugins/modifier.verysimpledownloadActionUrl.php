...
/**
 * The verysimpledownloadActionUrl modifier creates the URL for a given action.
 *
 ...
 */
function smarty_modifier_verysimpledownloadActionUrl($urlType, $urlFunc, $urlArguments)
{
    return DataUtil::formatForDisplay(ModUtil::url('VerySimpleDownload', $urlType, $urlFunc, $urlArguments));
}
