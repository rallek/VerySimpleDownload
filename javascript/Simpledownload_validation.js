...
function simdownReadDate(val, includeTime)
{
 ...
 */
function simdownAddCommonValidationRules(objectType, id)
{
    Validation.addAllThese([
        ['validate-nospace', Zikula.__('No spaces', 'module_simpledownload_js'), function(val, elem) {
            var valStr;
            valStr = new String(val);
            return (valStr.indexOf(' ') === -1);
        }],
        ['validate-upload', Zikula.__('Please select a valid file extension.', 'module_simpledownload_js'), function(val, elem) {
