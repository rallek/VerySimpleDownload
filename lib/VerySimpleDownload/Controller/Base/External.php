 ...
 */
class VerySimpleDownload_Controller_Base_External extends Zikula_AbstractController
{
    /**
    ...
    public function finder()
    {
        ...
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('VerySimpleDownload:' . ucwords($objectType) . ':', '::', ACCESS_COMMENT), LogUtil::getErrorMsgPermission());
        ...
        $categoryIds = ModUtil::apiFunc('VerySimpleDownload', 'category', 'retrieveCategoriesFromRequest', array('ot' => $objectType, 'source' => 'GET'));
