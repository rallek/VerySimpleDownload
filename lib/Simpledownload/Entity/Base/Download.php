 ...
 * @abstract
 */
abstract class Simpledownload_Entity_Base_Download extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var Simpledownload_Entity_Validator_Download The validator for this entity.
     */
     ...
     * @var text $docdescription.
     */
    protected $docdescription = '';
    
    /**
     * Uploaddocument meta data array.
     *
     * @ORM\Column(type="array")
     * @var array $uploaddocumentMeta.
     */
    protected $uploaddocumentMeta = array();
    
    /**
     * @ORM\Column(length=255)
     * @var string $uploaddocument.
     */
    protected $uploaddocument = '';
    
    /**
     * The full path to the uploaddocument.
     *
     * @var string $uploaddocumentFullPath.
     */
    protected $uploaddocumentFullPath = '';
    
    /**
     * Full uploaddocument path as url.
     *
     * @var string $uploaddocumentFullPathUrl.
     */
    protected $uploaddocumentFullPathUrl = '';
    
    /**
     * @ORM\OneToMany(targetEntity="Simpledownload_Entity_DownloadCategory", 
     *                mappedBy="entity", cascade={"all"}, 
     *                orphanRemoval=true)
     * @var Simpledownload_Entity_DownloadCategory
     */
     ...
     * Get _validator.
     *
     * @return Simpledownload_Entity_Validator_Download
     */
     ...
     * Set _validator.
     *
     * @param Simpledownload_Entity_Validator_Download $_validator.
     *
     * @return void
     */
    public function set_validator(Simpledownload_Entity_Validator_Download $_validator = null)
    {
     ...
     * Set doctitel.
     *
     * @param string $doctitel.
     *
     * @return void
     */
    public function setDoctitel($doctitel)
    {
        if ($doctitel != $this->doctitel) {
     ...
     * Set docdescription.
     *
     * @param text $docdescription.
     *
     * @return void
     */
    public function setDocdescription($docdescription)
    {
        if ($docdescription != $this->docdescription) {
    ...
    {
        if ($uploaddocument != $this->uploaddocument) {
            $this->uploaddocument = $uploaddocument;
        }
    }
    
    /**
     * Get uploaddocument full path.
     *
     * @return string
     */
    public function getUploaddocumentFullPath()
    {
        return $this->uploaddocumentFullPath;
    }
    
    /**
     * Set uploaddocument full path.
     *
     * @param string $uploaddocumentFullPath.
     *
     * @return void
     */
    public function setUploaddocumentFullPath($uploaddocumentFullPath)
    {
        if ($uploaddocumentFullPath != $this->uploaddocumentFullPath) {
            $this->uploaddocumentFullPath = $uploaddocumentFullPath;
        }
    }
    
    /**
     * Get uploaddocument full path url.
     *
     * @return string
     */
    public function getUploaddocumentFullPathUrl()
    {
        return $this->uploaddocumentFullPathUrl;
    }
    
    /**
     * Set uploaddocument full path url.
     *
     * @param string $uploaddocumentFullPathUrl.
     *
     * @return void
     */
    public function setUploaddocumentFullPathUrl($uploaddocumentFullPathUrl)
    {
        if ($uploaddocumentFullPathUrl != $this->uploaddocumentFullPathUrl) {
            $this->uploaddocumentFullPathUrl = $uploaddocumentFullPathUrl;
        }
    }
    
    /**
     * Get uploaddocument meta.
     *
     * @return array
     */
    public function getUploaddocumentMeta()
    {
        return $this->uploaddocumentMeta;
    }
    
    /**
     * Set uploaddocument meta.
     *
     * @param array $uploaddocumentMeta.
     *
     * @return void
     */
    public function setUploaddocumentMeta($uploaddocumentMeta = Array())
    {
        if ($uploaddocumentMeta != $this->uploaddocumentMeta) {
            $this->uploaddocumentMeta = $uploaddocumentMeta;
        }
    }
     ...
     *
     * @return Simpledownload_Entity_Validator_Download The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new Simpledownload_Entity_Validator_Download($this);
    ...
    public function initWorkflow()
    {
        ...
        $idColumn = 'id';
        $workflowHelper = new Simpledownload_Util_Workflow(ServiceUtil::getManager());
        ...
        if (!in_array($currentFunc, array('main', 'view', 'display')) && empty($isReuse)) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $this['_objectType'], $idColumn, 'Simpledownload');
            if (!$result) {
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'Simpledownload:Download:';
                $instance = $this->id . '::';
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'delete', 'arguments' => array('ot' => 'download', 'id' => $this['id'])),
                        'icon' => 'delete',
    ...
    {
        return 'simpledownload.ui_hooks.downloads';
    }
     ...
     *
     * @see Simpledownload_Entity_Download::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $uploadManager = new Simpledownload_UploadHandler();
        ...
        $this->formatTextualField('doctitel', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('docdescription', $currentFunc, $usesCsvOutput);
        if (!empty($this['uploaddocument'])) {
            try {
                $basePath = $controllerHelper->getFileBaseFolder('download', 'uploaddocument');
            } catch (\Exception $e) {
                return LogUtil::registerError($e->getMessage());
            }
        
            $fullPath = $basePath .  $this['uploaddocument'];
            $this['uploaddocumentFullPath'] = $fullPath;
            $this['uploaddocumentFullPathURL'] = System::getBaseUrl() . $fullPath;
        
            // just some backwards compatibility stuff
            /*if (!isset($this['uploaddocumentMeta']) || !is_array($this['uploaddocumentMeta']) || !count($this['uploaddocumentMeta'])) {
                // assign new meta data
                $this['uploaddocumentMeta'] = $uploadManager->readMetaDataForFile($this['uploaddocument'], $fullPath);
            }*/
        }
     ...
     *
     * @see Simpledownload_Entity_Download::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Simpledownload_Entity_Download::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Simpledownload_Entity_Download::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Simpledownload_Entity_Download::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
    protected function performPostRemoveCallback()
    {
        ...
        $uploadFields = array('uploaddocument');
     ...
     *     - no creation of other entities allowed
     *
     * @see Simpledownload_Entity_Download::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Simpledownload_Entity_Download::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Simpledownload_Entity_Download::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Simpledownload_Entity_Download::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    {
        $formattedTitle = $this->getDoctitel();
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity = new \Simpledownload_Entity_Download();
            // unset identifiers
            $entity->setId(null);
            // copy simple fields
            ...
            $entity->setDoctitel($this->getDoctitel());
            $entity->setDocdescription($this->getDocdescription());
            $entity->setUploaddocument($this->getUploaddocument());
