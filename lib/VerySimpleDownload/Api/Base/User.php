 ...
 */
class VerySimpleDownload_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getlinks()
    {
        ...
        if (in_array('download', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Download:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'download')),
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $routerFacade = new VerySimpleDownload_RouterFacade();
        ...
        $modInfo = ModUtil::getInfoFromName('VerySimpleDownload');
