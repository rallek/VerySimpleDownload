...
function vesidoReadDate(val, includeTime)
{
 ...
 */
function vesidoAddCommonValidationRules(objectType, id)
{
    Validation.addAllThese([
        ['validate-nospace', Zikula.__('No spaces', 'module_verysimpledownload_js'), function(val, elem) {
            var valStr;
            valStr = new String(val);
            return (valStr.indexOf(' ') === -1);
        }],
        ['validate-upload', Zikula.__('Please select a valid file extension.', 'module_verysimpledownload_js'), function(val, elem) {
