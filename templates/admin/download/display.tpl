...
<div class="simpledownload-download simpledownload-display">
    ...
    <div class="z-admin-content-pagetitle">
        ...
        <h3>{$templateTitle|notifyfilters:'simpledownload.filter_hooks.downloads.filter'}{icon id='itemActionsTrigger' type='options' size='extrasmall' __alt='Actions' class='z-pointer z-hide'}</h3>
    </div>
