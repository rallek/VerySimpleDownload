 ...
 */
class Simpledownload_Util_Base_View extends Zikula_AbstractBase
{
    /**
    ...
    {
        $extParams = array();
        $hasAdminAccess = SecurityUtil::checkPermission('Simpledownload:' . ucwords($objectType) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
