 ...
 */
class Simpledownload_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('This plugin shows a list of downloads of the Simpledownload module.');
    }
