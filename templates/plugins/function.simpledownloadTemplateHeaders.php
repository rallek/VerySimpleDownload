...
/**
 * The simpledownloadTemplateHeaders plugin performs header() operations
 ...
 */
function smarty_function_simpledownloadTemplateHeaders($params, $view)
{
    if (!isset($params['contentType'])) {
        $view->trigger_error($view->__f('%1$s: missing parameter \'%2$s\'', array('simpledownloadTemplateHeaders', 'contentType')));
    }
