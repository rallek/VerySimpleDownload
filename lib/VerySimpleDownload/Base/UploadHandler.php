 ...
 */
class VerySimpleDownload_Base_UploadHandler
{
    /**
    ...
    {
        $this->allowedObjectTypes = array('download');
        ...
        $this->allowedFileSizes = array('download' => array('fileUpload' => 102400));
    }
    ...
    protected function isAllowedFileExtension($objectType, $fieldName, $extension)
    {
        ...
        switch ($objectType) {
            case 'download':
                $allowedExtensions = array('pdf', 'doc', 'docx', 'zip');
                    break;
        }
    ...
    public function deleteUploadFile($objectType, $objectData, $fieldName, $objectId)
    {
        ...
        if (in_array($fileExtension, $this->imageFileTypes) && $fileExtension != 'swf') {
            ...
            $manager->setModule('VerySimpleDownload');
