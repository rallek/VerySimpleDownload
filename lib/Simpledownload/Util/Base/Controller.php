 ...
 */
class Simpledownload_Util_Base_Controller extends Zikula_AbstractBase
{
    /**
     * Returns an array of all allowed object types in Simpledownload.
     *
    ...
    /**
     * Returns the default object type in Simpledownload.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, actionHandler, block, contentType, util).
     * @param array  $args    Additional arguments.
     *
    ...
    public function getFileBaseFolder($objectType, $fieldName, $ignoreCreate = false)
    {
        ...
        $basePath = FileUtil::getDataDirectory() . '/Simpledownload/';
    
        switch ($objectType) {
            case 'download':
                $basePath .= 'downloads/uploaddocument/';
            break;
        }
    ...
    public function checkAndCreateAllUploadFolders()
    {
        ...
        $result &= $this->checkAndCreateUploadFolder('download', 'uploaddocument', 'pdf, zip, doc, docx, xls, xlsx');
    ...
    protected function checkAndCreateUploadFolder($objectType, $fieldName, $allowedExtensions = '')
    {
        ...
        $htaccessFileTemplate = 'modules/Simpledownload/docs/htaccessTemplate';
