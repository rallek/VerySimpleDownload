 ...
 */
class VerySimpleDownload_Util_Base_ListEntries extends Zikula_AbstractBase
{
    /**
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'download':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForDownload();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries.
     */
    public function getWorkflowStateEntriesForDownload()
    {
        $states = array();
