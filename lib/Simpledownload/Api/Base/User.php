 ...
 */
class Simpledownload_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $routerFacade = new Simpledownload_RouterFacade();
        ...
        $modInfo = ModUtil::getInfoFromName('Simpledownload');
