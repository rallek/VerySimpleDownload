...
/**
 * The verysimpledownloadFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_verysimpledownloadFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('VerySimpleDownload_Form_Plugin_FormFrame', $params, $content);
