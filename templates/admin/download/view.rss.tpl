...
{foreach item='download' from=$items}
    <item>
        ...
        <link>{modurl modname='Simpledownload' type='admin' func='display' ot='download' id=$download.id fqurl='1'}</link>
        <guid>{modurl modname='Simpledownload' type='admin' func='display' ot='download' id=$download.id fqurl='1'}</guid>
