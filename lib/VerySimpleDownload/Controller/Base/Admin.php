 ...
 */
class VerySimpleDownload_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function config()
    {
        ...
        // Execute form using supplied template and page event handler
        return $view->execute($templateName, new VerySimpleDownload_Form_Handler_Admin_Config());
    }
}
