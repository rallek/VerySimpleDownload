 ...
 */
class Simpledownload_Listener_ModuleDispatch extends Simpledownload_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('Simpledownload', 'user', 'main'), 'text' => __('Link Text'));
    }
}
