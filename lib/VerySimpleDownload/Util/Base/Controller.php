 ...
 */
class VerySimpleDownload_Util_Base_Controller extends Zikula_AbstractBase
{
    /**
     * Returns an array of all allowed object types in VerySimpleDownload.
     *
    ...
    public function getObjectTypes($context = '', $args = array())
    {
        ...
        $allowedObjectTypes[] = 'download';
    
        return $allowedObjectTypes;
    }

    /**
     * Returns the default object type in VerySimpleDownload.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, actionHandler, block, contentType, util).
     * @param array  $args    Additional arguments.
     *
    ...
    public function getFileBaseFolder($objectType, $fieldName, $ignoreCreate = false)
    {
        ...
        $basePath = FileUtil::getDataDirectory() . '/VerySimpleDownload/';
    
        switch ($objectType) {
            case 'download':
                $basePath .= 'downloads/fileupload/';
            break;
        }
    ...
    public function checkAndCreateAllUploadFolders()
    {
        ...
        $result &= $this->checkAndCreateUploadFolder('download', 'fileUpload', 'pdf, doc, docx, zip');
    ...
    protected function checkAndCreateUploadFolder($objectType, $fieldName, $allowedExtensions = '')
    {
        ...
        $htaccessFileTemplate = 'modules/VerySimpleDownload/docs/htaccessTemplate';
