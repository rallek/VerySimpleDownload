 ...
 */
class VerySimpleDownload_Api_Base_Search extends Zikula_AbstractApi
{
    /**
    ...
    public function search(array $args = array())
    {
        ...
        $searchTypes = isset($args['objectTypes']) ? (array)$args['objectTypes'] : (array) FormUtil::getPassedValue('verySimpleDownloadSearchTypes', array(), 'GETPOST');
        ...
        foreach ($searchTypes as $objectType) {
            ...
            switch ($objectType) {
                case 'download':
                    ...
                    $whereArray[] = 'tbl.downloadTitle';
                    $whereArray[] = 'tbl.downloadDescription';
                    $whereArray[] = 'tbl.fileUpload';
                    break;
            }
