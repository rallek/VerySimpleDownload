 ...
 */
class VerySimpleDownload_Util_Base_View extends Zikula_AbstractBase
{
    /**
    ...
    {
        $extParams = array();
        $hasAdminAccess = SecurityUtil::checkPermission('VerySimpleDownload:' . ucwords($objectType) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
