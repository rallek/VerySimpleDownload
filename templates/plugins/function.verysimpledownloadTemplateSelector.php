...
/**
 * The verysimpledownloadTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_verysimpledownloadTemplateSelector($params, $view)
{
