 ...
 */
class VerySimpleDownload_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('VerySimpleDownload detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single VerySimpleDownload object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('VerySimpleDownload', 'external', 'display', $this->getDisplayArguments());
        }
