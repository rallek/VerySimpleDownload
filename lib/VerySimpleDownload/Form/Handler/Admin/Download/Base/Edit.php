 ...
 */
class VerySimpleDownload_Form_Handler_Admin_Download_Base_Edit extends VerySimpleDownload_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            $modelHelper = new VerySimpleDownload_Util_Model($this->view->getServiceManager());
        ...
        if (count($this->listFields) > 0) {
            $helper = new VerySimpleDownload_Util_ListEntries($this->view->getServiceManager());
    ...
    public function applyAction(array $args = array())
    {
        ...
        try {
            ...
            $workflowHelper = new VerySimpleDownload_Util_Workflow($this->view->getServiceManager());
