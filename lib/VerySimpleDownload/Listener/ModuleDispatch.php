 ...
 */
class VerySimpleDownload_Listener_ModuleDispatch extends VerySimpleDownload_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('VerySimpleDownload', 'user', 'main'), 'text' => __('Link Text'));
    }
}
