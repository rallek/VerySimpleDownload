{* purpose of this template: downloads rss feed in admin area *}
...
{foreach item='download' from=$items}
    <item>
        ...
        <link>{modurl modname='VerySimpleDownload' type='admin' func='display' ot='download' id=$download.id fqurl='1'}</link>
        <guid>{modurl modname='VerySimpleDownload' type='admin' func='display' ot='download' id=$download.id fqurl='1'}</guid>
