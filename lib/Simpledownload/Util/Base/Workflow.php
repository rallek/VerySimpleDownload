 ...
 */
class Simpledownload_Util_Base_Workflow extends Zikula_AbstractBase
{
    /**
    ...
    public function getActionsForObject($entity)
    {
        ...
        $listHelper = new Simpledownload_Util_ListEntries($this->serviceManager);
