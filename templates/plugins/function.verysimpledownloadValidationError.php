...
/**
 * The verysimpledownloadValidationError plugin returns appropriate (and multilingual)
 ...
 */
function smarty_function_verysimpledownloadValidationError($params, $view)
{
    $id = $params['id'];
    $class = $params['class'];
